...
public class RequestSelectedRidesController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (String r : request.getParameterValues("selected_rides")){
            Ride.createRequest(Integer.parseInt(r), p.getEmailID(), request.getParameter("pickup_location"), request.getParameter("dropoff_location"));
        }
