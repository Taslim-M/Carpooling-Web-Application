...
<html>
    ...
    <form action="ConfirmRemovePassengerController"  align = "center"><input type = "hidden" name = "passenger_id" value = ${Passenger_ID}><input type = "hidden" name = "rideid" value = ${Ride_ID}><input type = "hidden" name = "choice" value = "RemoveRegistered"><input type="submit" value = "Remove Registered Passenger" class="btn btn-primary"></form>
    <br/>
